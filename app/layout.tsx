...
const bluuNext = localFont({
  src: [
    {path: './fonts/bluunext-bolditalic-webfont.woff2', weight: 'normal', style: 'italic'},
  {path: './fonts/bluunext-bold-webfont.woff2', weight: 'bold', style: 'normal'},
...
export default function RootLayout({
  ...
  return (
    <html lang="en">
      <body className={`rounded-xl font-sans min-h-screen ${gillSans.variable} ${bluuNext.variable}`}>
        <Navbar isDark />
        {children}
        <Footer />
      </body>
