    ...
    <main className='m-5 mb-auto'>
      <div className='mb-12'>
        <div className="mx-auto max-w-2xl">
            <h1 className="py-3 text-3xl font-bold tracking-tight sm:text-4xl pt-12">
              Notre cuisine
            </h1>
        ...
        <div className="mx-auto max-w-2xl">
            ...
            <p className="mt-4 text-lg">
              Aujourd’hui de retour en Bretagne, ils vous proposent leur vision d’une gastronomie de partage, respectueuse de l’humain comme de l’environnement, accueillante et inclusive, pensée pour et avec vous.          </p>
        </div>
      </div>
    </main>
  )
