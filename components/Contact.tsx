...
import contactPic from "../public/photos/contact.jpg"
...
export default function Contact() {
  return (
    <div className="relative">
      <ContactBg />
      <div className="absolute lg:inset-0 lg:left-1/2">
        <Image
          className="bg-slate-50 object-cover"
          src={contactPic}
          alt="Passage Rennes - Contact"
          fill
        />
      </div>
      <div className="pb-32 pt-32 lg:mx-auto lg:grid lg:max-w-7xl lg:grid-cols-2 lg:pt-32">
        <div className="px-6 lg:px-8">
          <div className="mx-auto max-w-xl lg:mx-0 lg:max-w-lg">
            <h1 className="text-6xl font-serif font-bold tracking-tight text-slate-900 sm:text-9xl">
              Passages
            </h1>
            <p className="mt-6 text-4xl font-medium leading-8 text-slate-900">
              Rennes
            </p>
    ...
    </div> // <div className="relative bg-transparent min-h-screen">
    //   <ContactBg></ContactBg>
    //   <div className="lg:absolute lg:inset-0 lg:left-1/2">
    //     <Image
    //       className="h-64 w-full bg-slate-50 object-cover sm:h-80 lg:absolute lg:h-full"
    //       src={contactPicture}
    //       width={1200}
    //       height={1200}
    //       alt=""
