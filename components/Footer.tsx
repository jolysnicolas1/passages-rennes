  ...
  return (
    <footer className="bg-slate-950">
      <div className="mx-auto max-w-7xl overflow-hidden px-6 py-20 sm:py-24 lg:px-8">
        ...
        <p className="mt-10 text-center flex justify-center text-sm leading-5 text-slate-50">
        ...
        <p className="mt-2 text-center flex justify-center text-sm leading-5 text-slate-50">
