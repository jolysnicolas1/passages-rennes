...
export const socials = [
  {
    name: "place Clara Zetkin, 35000 Rennes",
  ...
  {
    name: "Réservation : 07.83.10.18.81",
    href: "tel:0783101881",
    // eslint-disable-next-line @typescript-eslint/no-explicit-any
    icon: (props: any) => <PhoneCall {...props} />,
  },
  {
    name: "Traiteur : 06.51.96.14.94",
    href: "tel:0783101881",
    // eslint-disable-next-line @typescript-eslint/no-explicit-any
    icon: (props: any) => <PhoneCall {...props} />,
  },
  ...
  {
    name: "Instagram",
    href: "https://instagram.com/passages.bzh?igshid=ZDdkNTZiNTM=",
    // eslint-disable-next-line @typescript-eslint/no-explicit-any
    icon: (props: any) => (
      <svg
        fill="currentColor"
